...
public class Utility {
    ...
    /**Return an iterator, that returns tiles ordered correctly
     * to satisfy the needs of food production and production treasury
     * in Eta Civ.
     * @param center from witch the adjacent tiles should be analysed and sorted
     * @param game, current game implementation in order to access the properties of each analysed tiles
     * @param cityFocus to determine which tiles to order first
     * @return iterator over the sorted tiles, used for determining the production of a city
     */
